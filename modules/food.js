...
async function loadData() {
    try {
        ...
        // ذخیره idهای دسته‌بندی‌ها برای استفاده بعدی
        window.categoryMap = {};
...
export function analyzeInventoryNutrition() {
    // این تابع با داده‌های محلی کار می‌کند
    // در صورت نیاز به داده‌های خارجی، می‌توان آن را توسعه داد
    return {
        calories: 0,
        protein: 0,
        carbs: 0,
